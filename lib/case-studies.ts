...
export const caseStudies: CaseStudy[] = [
  ...
  {
    slug: "war-room-polygon",
    role: "Product Manager",
    order: 4,
    title: "Polygon RFS: capital meets builders",
    tagline: "A matchmaker for Web3 founders and ecosystem funding.",
    company: "War Room × Polygon",
    year: "2023",
    duration: "Mar '23 → Dec '23",
    domain: ["Web3", "B2B", "Marketplace"],
    accent: "peach",
    emoji: "🛰️",
    hook: "Every Web3 ecosystem says it supports builders. Most of them do it over DMs. We built the actual platform.",
    tldr: "Spearheaded Polygon's Request for Startups (RFS) platform — a structured marketplace where hundreds of Web3 projects could access ecosystem funding, grants, and partnerships without cold-DMing an exec.",
    metrics: [
      { value: "100s", label: "projects onboarded" },
      { value: "95%+", label: "feature delivery" },
      { value: "2-sided", label: "marketplace" },
    ],
    chapters: [
      {
        heading: "the problem nobody wanted to own",
        body: "Polygon's ecosystem was flooded with founders who wanted support, and internal teams drowning in unstructured DMs. A classic two-sided marketplace problem dressed up as 'community work'. Nobody owned it end-to-end until the brief landed on my desk.",
      },
      {
        heading: "building the right primitives",
        body: "The product wasn't 'a form'. It was a taxonomy: what kind of ask, what stage, what vertical, what Polygon cares about this quarter. We prototyped three versions with real founders before writing the first line of production code. The winning design made founders feel heard in 60 seconds and gave internal reviewers a ranked queue.",
      },
      {
        heading: "shipping in crypto time",
        body: "Web3 moves in thematic waves — DeFi this month, gaming next, ZK the month after. I baked 'themes' into the RFS schema so Polygon could re-point the funnel without a code change. That one decision bought the platform a much longer life than a hardcoded version would've had.",
      },
    ],
    stack: ["Notion", "Figma", "Jira", "Postman", "Discord"],
    shipped: [
      "RFS platform, 2-sided marketplace",
      "Themed intake for shifting ecosystem priorities",
      "Ranked review queue for internal teams",
      "Hundreds of projects onboarded",
    ],
  },
  {
    slug: "under-25",
